...
/** Wi-Fi AP Settings. */
#define MAIN_WLAN_SSID                       "APT311-2.4" /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH                       M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK                        "walnut311" /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */

/** IP address parsing. */
#define IPV4_BYTE(val, index)                ((val >> (index * 8)) & 0xFF)

/** Content URI for download. */
#define MAIN_HTTP_FILE_URL                   "https://www.seas.upenn.edu/~jjfrank/UTAFO.bin" ///<Change me to the URL to download your OTAU binary file from!
...
#define PLAYER2 2 ///<Comment me to compile for player 2. Uncomment me to define for player 1.

#ifdef PLAYER1
/* Chat MQTT topic. */
#define LED_TOPIC			"P1_LED_ESE516_T67"	//Students to change to an unique identifier for each device! LED Data
#define GAME_TOPIC_IN			"P1_GAME_ESE516_T67" //Students to change to an unique identifier for each device! Game Data
#define GAME_TOPIC_OUT			"P2_GAME_ESE516_T67" //Students to change to an unique identifier for each device! Game Data
#define IMU_TOPIC			"P1_IMU_ESE516_T67" //Students to change to an unique identifier for each device! IMU Data
#define DISTANCE_TOPIC			"P1_DISTANCE_ESE516_T67" //Students to change to an unique identifier for each device! Distance Data
#define	JX_GAME_ON		"JX_game_on_usr1"
#define	RT_GAME_INPUT_USR1		"RT_usr1_input"
#define	RT_GAME_INPUT_USR2		"RT_usr2_input"
#define ANS_SEQ_USR1			"ans_seq_usr1"
...
#define	ANS_SEQ_USR2		"cl_ans_seq_usr1"
#define GAME_RESULT			"game_res_usr2"
#define	RT_GAME_INPUT_USR2		"RT_usr2_input"
#define ANS_SEQ_USR1			"ans_seq_usr1"
...
//Cloud MQTT User
#define CLOUDMQTT_USER_ID	"jxgame"
